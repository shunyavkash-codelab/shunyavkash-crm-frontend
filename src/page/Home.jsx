  ...
  <Box sx={{ mt: 6 }}>
    ...
    <Grid container rowSpacing={2} columnSpacing={2}>
        <Grid
            ...
            sm={6}
            xxl={4}
            sx={{ "& .statusBtn":{ color:"primary.contrastText" , fontSize: { xs:"10px" , lg:"12px" } , px:0.75 , py:0.5 , bgcolor:"grey.dark" , borderRadius:1 },"& .pending":{ bgcolor:"secondary.main" },"& .Done":{ bgcolor:"success.main" } }}
          >
